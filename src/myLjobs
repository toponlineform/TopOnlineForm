...
// --- 28. HPRCA Assistant Staff Nurse Recruitment 2025 ---
{
  ...
  
  {
    ...
    importantDates: [
      ...
      { label: "Application Begin", value: "09/12/2025" },
      { label: "Last Date for Apply", value: "31/12/2025" },
      { label: "Exam Date", value: "To be notified" }
    ],
    ...
    links: [
      ...
      { title: "Download Notification (Soon)", url: "https://www.drdo.gov.in/drdo/sites/default/files/vacancy/CEPTAM-11_AdvtEnglish.pdf" },
      { title: "Download Short Notice", url: "https://www.drdo.gov.in/drdo/sites/default/files/vacancy/shortadvtC11_04122025.pdf" }, // Replace with direct PDF link if hosted
