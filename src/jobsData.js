...
// --- 0. KVS & NVS Recruitment (NEWEST) ---
  ...
  // --- 6. SSC CPO SI Paper-I (ID 1006) - FULLY DETAILED ---
  {
    ...
    // Fee Details from Notification (Page 11)
    applicationFee: [
      { category: "General / OBC / EWS", amount: "₹100/-" },
    ...
    // Extra Section: Physical Standards (PST) - PDF Page 17
    extraSections: [
      {
    ...
    // Region-Wise Direct Links (SEO Friendly)
    links: [
      ...
      { title: "Download Notification PDF", url: "https://ssc.gov.in/api/attachment/uploads/master/notice_2025_09_26.pdf" }, // Official Link if available or use your hosted link
      { title: "Official Website", url: "https://ssc.gov.in/" }
    ]
  },
   // --- 5. SSC JE (ID 1005) ---
  {
    ...
    // Region Wise Links for User Convenience
    links: [
      { title: "Download Admit Card (NR - Delhi/Raj/UK)", url: "https://sscnr.nic.in/" },
      { title: "Download Admit Card (CR - UP/Bihar)", url: "http://www.ssc-cr.org/" },
      { title: "Download Admit Card (WR - Maha/Guj/Goa)", url: "http://www.sscwr.net/" },
      { title: "Download Admit Card (ER - WB/Odisha/Jhar)", url: "http://www.sscer.org/" },
      { title: "Download Admit Card (SR - AP/Tel/TN)", url: "http://www.sscsr.gov.in/" },
      { title: "Download Admit Card (KKR - Kar/Ker)", url: "http://www.ssckkr.kar.nic.in/" },
      { title: "Download Admit Card (MPR - MP/Chattis)", url: "http://www.sscmpr.org/" },
      { title: "Download Admit Card (NWR - Chd/Pun/Har)", url: "http://www.sscnwr.org/" },
      { title: "Download Admit Card (NER - North East)", url: "http://www.sscner.org.in/" },
      { title: "Official Website", url: "https://ssc.gov.in/" }
    ]
  },
];
